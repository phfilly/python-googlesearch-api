Quick little python application which pulls the google trends data (interest over time and interest by region) and displays it in an two easy to read charts.
